...
const Sidebar = () => {
  const linkClass = ({ isActive }) =>
    isActive
      ? 'font-sans bg-black w-full font-bold text-blue-400 hover:bg-gray-900 hover:text-blue-400 rounded-md px-3 py-2 flex item-center'
      : 'font-sans text-black w-full hover:bg-gray-900 hover:font-bold hover:text-blue-300 rounded-md px-3 py-2 flex';
  ...
  return (
    <nav className="hidden sm:w-[296px] bg-blue-300 text-black sm:flex flex-col pt-5 min-h-screen p-4">
      <h1 className='text-2xl font-extrabold text-blue-950 text-center font-serif mb-10 mt-8'>Mega Mind</h1>
